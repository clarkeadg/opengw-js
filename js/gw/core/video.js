...
//export const VIDEO_SCREEN_W           = 320;
//export const VIDEO_SCREEN_H           = 180;

//export const VIDEO_SCREEN_W           = 500;
//export const VIDEO_SCREEN_H           = 250;
...
export const video_init = (window_title, resolution, smooth, fullscreen, bpp, show_fps) => {
  ...
  //canvas2.width = VIDEO_SCREEN_W;
  //canvas2.height = VIDEO_SCREEN_H;
