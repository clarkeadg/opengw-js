...
export const IB_AXES_LEFT  = 10;
export const IB_AXES_RIGHT = 11;
export const IB_W          = 12;
export const IB_S          = 13;
export const IB_D          = 14;
export const IB_A          = 15;
  ...
  for(it = inlist; it; it=it.next) {
    ...
    switch(it.data.type) {
      ...
      case IT_USER:
        ...
        it.data.state[IB_W]   = arrows.w;
        it.data.state[IB_A]   = arrows.a;
        it.data.state[IB_S]   = arrows.s;
        it.data.state[IB_D]   = arrows.d;
        ...
        if (enableVirtualJoystick) {
          ...
          // bottom left
          it.data.state[IB_W] = joystick.up();
          it.data.state[IB_S] = joystick.down();
          it.data.state[IB_A] = joystick.left();
          it.data.state[IB_D] = joystick.right();

          // bottom right
          it.data.state[IB_UP] = joystick2.up();
          it.data.state[IB_DOWN] = joystick2.down();
          it.data.state[IB_LEFT] = joystick2.left();
          it.data.state[IB_RIGHT] = joystick2.right();
        ...
        if (gp) {
          ...
          it.data.state[IB_AXES_LEFT]  = { x: -gp.axes[1], y: -gp.axes[0], z: 0 };
          it.data.state[IB_AXES_RIGHT] = { x: -gp.axes[3], y: -gp.axes[2], z: 0 };
